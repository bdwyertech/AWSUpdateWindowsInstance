...
Function Expand-ZipFile
{
    <#
        ...
        .PARAMETER File
        The file which you want to extract.

        .PARAMETER Destination
        The path in which we want to save the extract files.
    ...
    Process
    {
        ...
        if($psVerMajor -ge 5)
        {
            Expand-Archive -Path $File -DestinationPath $Destination -Force | Out-Null
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDPEc6ON5pePjxT
# p3YC0DWBoiukVK1eJhu68WjRjCEgT6CCDJwwggXYMIIEwKADAgECAhABVznfx2xi
...
# IIJDRiF5DaSVOAiTFg2Ftdbgvm/ShqdhfIJPFTuEVuLUMA0GCSqGSIb3DQEBAQUA
# BIIBADYsey6alBXglIBSnCWMTrpYLnDR8CHoHU6ldc7QDCJZzGxN4zLwDZRI5odN
# kDmKlpglIK/SfvWfdMm7bljVgBjaEiKLWqBvPvDBBMEf/dWr5+zGEh1+iXc+QB+u
# pfKv+LUX6PCeOHJ9SoR6FSR66SiIx8bPnrLJr7+xtMA4CkhKArXjUcaIRyMaTTBX
# bwZx0SHS0StssFVtg9NVmEzLvAJ+DNrlyHmUQIWAGGUZrKDH4kTa+X3XnHM6kKPS
# Ut4bN3onkml9/iJhi193PFztNVqUTF0PZkzzPWkeQfMJ3ztcPs2SCuN0Yg0n7ilT
# lFjvlFYirwssxCxwbIplroq1HBGhgg7IMIIOxAYKKwYBBAGCNwMDATGCDrQwgg6w
# BgkqhkiG9w0BBwKggg6hMIIOnQIBAzEPMA0GCWCGSAFlAwQCAQUAMHcGCyqGSIb3
# DQEJEAEEoGgEZjBkAgEBBglghkgBhv1sBwEwMTANBglghkgBZQMEAgEFAAQgBUtk
# AdnMD1/zpOPKmbQ5914S2GQTH7ccwEnf+JrITRECED/Yie3PTjux7KIMVKbrzYIY
# DzIwMTgwNTMxMTk1NDI1WqCCC7swggaCMIIFaqADAgECAhAJwPxGyARCE7VZi68o
...
# BDAcBgkqhkiG9w0BCQUxDxcNMTgwNTMxMTk1NDI1WjAvBgkqhkiG9w0BCQQxIgQg
# x9zPtn4wWcIpciT8K/JX1KPDD1/iAvW6L5R3v5dKQgwwKwYLKoZIhvcNAQkQAgwx
# HDAaMBgwFgQUQAGRR1yYiR3roQSvRwkbXrbUy8swDQYJKoZIhvcNAQEBBQAEggEA
# R9J5fWKyPymXxtEE6XvOCRzaiGhr7VJDWCIiGJlMQ/jBIPuXsBGYsZiIJk1forMW
# 6KI/yrLhjrAx4YzQRROcUPV0zpFNn2xrHReOp9Zu/M2WFRvka/2NHuUlmRZGxAip
# 6cSj8zlwrhRd6wTiR/ovfNcAi2SkGJXS19szO7YMy13nqkzx3SQmN5nvimLe0kpC
# RtQY3GFNKw3PVLpzv8uRR2Ds38yHuymxQv6rRmt4Y/gsfoBOr/uQlqRN6WyEjRSZ
# 7yYM/E6QW5i1W1V8c90pHJY3+JO5j1kFtjcd64eq6gyyhufzEQLLGH07sVLSBBJF
# zTgllyg3rd6AAx31otUopw==
